...
import { ChatMessage, UserGender } from "../types";
...
export function ChatScreen({ onBack, messages, onSend, userGender = "male" }: Props) {
          ...
          ListEmptyComponent={
            <View style={styles.emptyWrap}>
              <LinearGradient colors={[...gradients.accent]} style={styles.emptyCard}>
                <MariAvatar size={64} style={styles.emptyAvatar} />
          ...
          renderItem={({ item }) => (
            ...
            >
              {item.role === "assistant" ? (
                ...
                <View style={[styles.roleRow, styles.userRoleRow]}>
                  <Text style={styles.userRoleLabel}>YOU</Text>
                  <UserAvatar gender={userGender} size={24} />
                </View>
              )}
              {item.role === "user" ? (
                <LinearGradient
